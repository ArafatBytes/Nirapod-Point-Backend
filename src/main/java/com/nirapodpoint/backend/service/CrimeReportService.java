...
public class CrimeReportService {
    ...
    public List<CrimeReport> getCrimeReports(String type, int page, int size, 
        ...
        // Add bounds criteria if provided
    ...
    public Map<String, Object> getDistrictStatistics() {
        ...
        // Count crimes per district and time-based stats
        ...
        for (CrimeReport crime : allCrimes) {
            String district = DistrictUtil.findDistrict(
                crime.getLocation().getY(),  // lat
                crime.getLocation().getX()   // lng
            );
        ...
        // Convert to list and sort districts
        ...
        // Process safest districts (last 5)
        ...
        Collections.reverse(safestDistricts); // Reverse to show safest first
